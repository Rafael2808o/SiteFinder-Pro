    ...
    <div className="relative">
      ...
      <Card className="overflow-hidden p-0 shadow-xl">
        ...
        <div className="flex flex-col gap-3 p-4">
          {[
            { name: 'Padaria Bela Vista', category: 'Padaria', status: 'sem_site', score: 84 },
            { name: 'Studio Ana Corte & Cor', category: 'Salão de beleza', status: 'possivel_site', score: 63 },
            { name: 'Clínica Odonto Sorriso', category: 'Dentista', status: 'com_site', score: 22 },
          ].map((lead) => (
            <div
              key={lead.name}
